...
import com.sparta.doguin.domain.answer.service.EventAnswerService;
...
public class EventAnswerController {
    ...
    public EventAnswerController(EventAnswerService answerService) {
        this.answerService = answerService;
    }

    // 자유게시판 댓글 생성
    @PostMapping("events/{boardId}/answer")
    ...
    // 자유게시판 댓글 수정
    @PutMapping("events/{boardId}/answer/{answerId}")
    ...
    @GetMapping("events/{boardId}/answer")
    ...
    @GetMapping("events/{boardId}/answer/{answerId}")
    ...
    @DeleteMapping("events/{boardId}/answer/{answerId}")
