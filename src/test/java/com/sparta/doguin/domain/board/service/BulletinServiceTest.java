...
class BulletinServiceTest {
    ...
    void create() {
        BoardRequest.BoardCommonRequest boardCommonRequest = new BoardRequest.BoardCommonRequest("일반 게시물","일반 게시물", null);
    ...
    void update() {
        BoardRequest.BoardCommonRequest boardCommonRequest = new BoardRequest.BoardCommonRequest("수정된 일반 게시물","수정된 일반 게시물",null);
