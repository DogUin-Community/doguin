...
public class ApplyAnswerServiceTest {
    ...
    void 대답변_등록_생성_성공_시() {
        ...
        ApiResponse<AnswerResponse.Response> response = applyAnswerService.create(request);
    ...
    void 대답변_수정_성공_시() {
        ...
        ApiResponse<AnswerResponse.Response> response = applyAnswerService.update(1L, request);
    ...
    void 대답변_단건_조회_성공_시() {
        ...
        ApiResponse<AnswerResponse.Response> response = applyAnswerService.viewOne(answerId);
    ...
    void 대답변_삭제_성공_시() {
        ...
        ApiResponse<Void> response = applyAnswerService.delete(1L);
